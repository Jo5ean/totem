const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://totem-api-production.up.railway.app';
...
export const totemApi = {
  ...
  getEstadisticasLite: () => apiClient.get('/totem/estadisticas'), // Usar endpoint principal  
  getEstadisticasSimple: () => apiClient.get('/totem/estadisticas'), // Usar endpoint principal
